        ...
        <div className="bg-white w-full max-w-4xl rounded-2xl shadow-xl border border-gray-100 p-6 sm:p-10">
          ...
          <div className="flex flex-col-reverse sm:flex-row justify-end gap-4 pt-8 border-t mt-10">
            ...
            <button
              ...
              className="w-full sm:w-auto flex items-center justify-center gap-2 text-white px-6 py-2.5 rounded-full font-semibold shadow-md bg-linear-to-r from-[#155DFC] to-[#00B8DB] hover:shadow-lg transition-all"
            >
              <Edit2 size={20} />
              Edit Job
            </button>
